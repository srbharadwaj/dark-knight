 ...
 */
public class ChessBoardMyJToggleButtonUI extends JToggleButton implements ItemListener, chessConstants {
    ...
    //test constructor
    public ChessBoardMyJToggleButtonUI(ChessBoardUI ja) {
        super();
    ...
    //test constructor
    public ChessBoardMyJToggleButtonUI() {
        super();
        //System.out.println("Created");
        //njf=ja;
        //setChessp(null);
    ...
    //test constructor
    public ChessBoardMyJToggleButtonUI(String s) {
        super();
        this.setText(s);
        //System.out.println("Created");
        //njf=ja;
    ...
    public void setChessp(chessPiece p) {
        chessp = p;
    }

    public chessPiece getChessp() {
        return chessp;
    }
    ...
    public void itemStateChanged(ItemEvent e) {
        ChessBoardMyJToggleButtonUI j = (ChessBoardMyJToggleButtonUI) e.getSource();
        if (j.isSelected()) {
